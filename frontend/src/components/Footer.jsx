          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p className="flex items-start">
                ...
                <a href="mailto:support@vconstech.in" className="break-all hover:text-[#ffbe01] transition-colors duration-200">
                  support@vconstech.in
                </a>
              </p>
              ...
              <p className="flex items-start">
                ...
                <a href="mailto:vconstecherp@gmail.com" className="break-all hover:text-[#ffbe01] transition-colors duration-200">
